  ...
  $defs: {
    ...
    schema_root: {
      ...
      properties: {
        ...
        example: {},
        properties: { type: "object", additionalProperties: { $ref: "#/$defs/schema_node" }, description: "Every fixed business field schema belongs here; do not place named field schemas beside properties." },
  ...
  return {
    ...
    interface_doc_contract: {
      ...
      common_schema_mistakes: [
        ...
        "For an object schema, put every named business field under schema.properties; do not place field schemas beside properties.",
      ],
